...
const brands = [
  {
    ...
    description:
      "From Italian and German kitchen furniture, bathrooms, wardrobes, and tiles, Biente transforms essential spaces into areas of inspiration and confidence. These are the places where new ideas take shape, where refined interior design creates a protective and harmonious living environment.",
  ...
  },
  {
    ...
    description:
      "Inspiring architectural solutions for modern living. Àper brings innovative design concepts that blend form and function seamlessly.",
    image: aperImage,
    link: "#aper",
    featured: false,
  },
  {
    ...
    description:
      "Luxury real estate redefined, offering exclusive properties in prime locations across Greece.",
    image: astateImage,
    link: "#astate",
    featured: false,
  },
        ...
        <div className="mb-12">
          <div className="grid lg:grid-cols-2 gap-8 items-center bg-background rounded-sm overflow-hidden">
            <div className="relative h-80 lg:h-full min-h-[400px]">
              <img
                src={brands[0].image}
                alt={`${brands[0].name} - ${brands[0].tagline}`}
                className="absolute inset-0 w-full h-full object-cover"
              />
            </div>
            <div className="p-8 lg:p-12">
              <span className="label-uppercase mb-2 block">Featured Brand</span>
