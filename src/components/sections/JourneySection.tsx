    ...
    <section id="journey" className="section-padding bg-card">
      <div className="section-container">
        <div className="text-center mb-16">
          <span className="label-uppercase mb-4 block">Our History</span>
          ...
          <div className="space-y-8 md:space-y-12">
            {timelineEvents.map((event, index) => (
              ...
              >
                {/* Year Marker */}
                <div
                  className={`absolute left-4 md:left-1/2 w-3 h-3 rounded-full bg-accent border-4 border-background transform -translate-x-1/2 mt-2 z-10`}
                />
